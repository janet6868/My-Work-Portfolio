...
// *** Section 1 ***
var aoi = ee.FeatureCollection('projects/ee-janet/assets/senegal/52_grid_dagana');
...
Map.addLayer(edges, {
    palette: 'red'
}, 'Detected water edges',false);
var edgesVis = {
    palette: 'yellow',
    opacity: 0.5
};
Map.addLayer(bufferedEdges.selfMask(), edgesVis,
    'Buffered water edges',false);
...
Map.addLayer(localWater.selfMask(),
    ...
    'Water (adaptive threshold)',false);
